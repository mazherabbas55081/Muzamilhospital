...
DEPARTMENTS = {
    "Cardiology": {"icon": "❤️", "desc": "Heart & cardiovascular care, ECG, Angiography", "head": "Dr. Mazhar Abbas"},
    "Neurology": {"icon": "🧠", "desc": "Brain, spine & nervous system treatments", "head": "Dr. Saniah Malik"},
    "Orthopedics": {"icon": "🦴", "desc": "Bones, joints & sports injuries", "head": "Dr. Nouman Khan"},
    "Pediatrics": {"icon": "👶", "desc": "Child healthcare, vaccination & growth", "head": "Dr. Jamshid"},
    "Gynecology": {"icon": "👩‍⚕️", "desc": "Women's health, maternity & prenatal care", "head": "Dr. Maryyam Siddiqui"},
    ...
    "ENT": {"icon": "👂", "desc": "Ear, nose & throat specialists", "head": "Dr. Muzamil Abbas"},
    "Oncology": {"icon": "🎗️", "desc": "Cancer diagnosis & treatment", "head": "Dr. Abid Nawaz"},
    "Radiology": {"icon": "🩻", "desc": "X-Ray, MRI, CT Scan & Ultrasound", "head": "Dr. Hammad Arain"},
}

DOCTORS = [
    {"name": "Dr. Mazhar Abbas", "dept": "Cardiology", "days": "Mon, Wed, Fri", "time": "9:00 AM - 2:00 PM", "fee": 2000, "exp": "18 years", "img": "assets/doctors/mazhar.jpg"},
    ...
    {"name": "Dr. Nouman Khan", "dept": "Orthopedics", "days": "Mon, Tue, Thu", "time": "8:00 AM - 1:00 PM", "fee": 1800, "exp": "12 years", "img": "assets/doctors/nouman.jpg"},
    {"name": "Dr. Jamshid", "dept": "Pediatrics", "days": "Mon - Fri", "time": "9:00 AM - 3:00 PM", "fee": 1500, "exp": "10 years", "img": "assets/doctors/jamshid.jpg"},
    {"name": "Dr. Maryyam Siddiqui","dept": "Gynecology", "days": "Wed, Fri, Sat", "time": "11:00 AM - 5:00 PM", "fee": 2200, "exp": "16 years", "img": "assets/doctors/maryyam.jpg"},
    ...
    {"name": "Dr. Muzamil Abbas", "dept": "ENT", "days": "Mon, Thu, Fri", "time": "9:30 AM - 2:30 PM", "fee": 1600, "exp": "11 years", "img": "assets/doctors/muzamil.jpg"},
    {"name": "Dr. Abid Nawaz", "dept": "Oncology", "days": "Tue, Fri", "time": "12:00 PM - 5:00 PM", "fee": 3000, "exp": "20 years", "img": "assets/doctors/abid.jpg"},
    {"name": "Dr. Hammad Arain", "dept": "Radiology", "days": "Mon - Sat", "time": "8:00 AM - 8:00 PM", "fee": 1200, "exp": "13 years", "img": "assets/doctors/hammad.jpg"},
]
...
def home_page():
    show_image("assets/banner.jpg", fallback_emoji="🏥")
    st.markdown(f"""
    <div class="main-header">
        <h1>🏥 {HOSPITAL['name']}</h1>
        <p>{HOSPITAL['location']} • Tehsil {HOSPITAL['tehsil']} • District {HOSPITAL['district']}</p>
...
def main():
    ...
    with st.sidebar:
        show_image("assets/logo.png", fallback_emoji="🏥", width=80)
